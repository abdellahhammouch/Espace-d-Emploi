<x-app-layout>
                ...
                <aside class="col-span-4 lg:col-span-3 h-full">
                    <div class="h-full bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden flex flex-col">
                        ...
                        <div class="flex-1 overflow-y-auto p-3 space-y-1">
                            ...
                            <a href="#" class="flex items-center gap-3 p-3 rounded-2xl transition-all hover:bg-slate-50">
                                <div class="w-12 h-12 rounded-2xl bg-indigo-500 text-white flex items-center justify-center font-bold shadow-md">
                                                ...
                                                @if($message->file_path)
                                                    <div class="mt-2">
                                                        ...
                                                        @elseif($message->type === 'video')
                                                            <div class="rounded-xl overflow-hidden border-2 border-white/20 shadow-sm bg-black">
                                                        ...
                                                        @else
                                                            <a href="{{ asset('storage/' . $message->file_path) }}" target="_blank" download class="flex items-center gap-3 p-3 rounded-xl bg-black/10 hover:bg-black/20 transition-colors border border-white/20 group">
                            ...
                            <form action="{{ route('message.send') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-2">
                                ...
                                <div class="flex items-center gap-3 bg-slate-50 p-2 rounded-3xl border border-slate-200 focus-within:border-indigo-400 transition-all focus-within:ring-4 focus-within:ring-indigo-100">
                                    ...
                                    <input type="text" name="content" placeholder="Type your message..." 
                                        class="flex-1 bg-transparent border-none focus:ring-0 text-sm py-3 text-slate-700 placeholder-slate-400" autocomplete="off">
    ...
    <div id="receiverID" data-id="{{ $receiver->receiver_id }}" ></div>
