                            ...
                            <div class="flex-1 overflow-y-auto p-2">
                                    <a href="#"
                                       ...
                                       {{ isset($activeFriend) && $activeFriend->id === $friend->id ? 'bg-indigo-50 ring-1 ring-indigo-100' : '' }}">
                                        ...
                                        <!-- Avatar -->
                                        <div class="w-8 h-8 rounded-2xl bg-gradient-to-br from-indigo-600 to-blue-600 text-white grid place-items-center font-bold">
                        ...
                        <div class="h-full bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden flex flex-col">
                            ...
                            <div class="px-5 py-4 border-b bg-white">
                                <div class="flex items-center gap-3">
                                    <div class="w-11 h-11 rounded-2xl bg-gradient-to-br from-indigo-600 to-blue-600 text-white grid place-items-center font-bold">
                                    ...
                                    @foreach($messages as $message)
                                        @if($message->sender_id === auth()->id())
                                            ...
                                            <div class="flex justify-end">
                                                <div class="max-w-[70%]">
                                                    <div class="bg-white text-slate-900 px-4 py-2.5 rounded-3xl rounded-br-sm shadow-sm border border-slate-200">
                                        ...
                                        @else
                                            ...
                                            <div class="flex justify-start">
                                                <div class="max-w-[70%]">
                                                    <div class="bg-gradient-to-br from-indigo-600 to-blue-600 text-white px-4 py-2.5 rounded-3xl rounded-bl-sm shadow-sm">
                                                        <p class="text-sm break-words leading-relaxed">{{ $message->content }}</p>
                                                    </div>
                            ...
                            <div class="border-t bg-white px-4 py-3">
                                <form action="{{ route('message.send') }}" method="POST" class="flex items-center gap-3">
                                    @csrf
